...
namespace DirectX
{
    ...
    {
        VertexPositionNormalTextureTangentBinormal() = default;

        VertexPositionNormalTextureTangentBinormal(const VertexPositionNormalTextureTangentBinormal&) = default;
        VertexPositionNormalTextureTangentBinormal& operator=(const VertexPositionNormalTextureTangentBinormal&) = default;

        VertexPositionNormalTextureTangentBinormal(VertexPositionNormalTextureTangentBinormal&&) = default;
        VertexPositionNormalTextureTangentBinormal& operator=(VertexPositionNormalTextureTangentBinormal&&) = default;

        VertexPositionNormalTextureTangentBinormal(XMFLOAT3 const& iposition, XMFLOAT3 const& inormal, XMFLOAT2 const& itextureCoordinate, XMFLOAT3 const& itangent, XMFLOAT3 const& ibinormal)
            : position(iposition),
            normal(inormal),
            textureCoordinate(itextureCoordinate),
            tangent(itangent),
        ...
        VertexPositionNormalTextureTangentBinormal(FXMVECTOR iposition, FXMVECTOR inormal, FXMVECTOR itextureCoordinate, FXMVECTOR itangent, FXMVECTOR ibinormal)
        {
            XMStoreFloat3(&this->position, iposition);
            XMStoreFloat3(&this->normal, inormal);
            XMStoreFloat2(&this->textureCoordinate, itextureCoordinate);
            XMStoreFloat3(&this->tangent, itangent);
            XMStoreFloat3(&this->binormal, ibinormal);
        }
